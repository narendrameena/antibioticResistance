...
###################################################
#biocLite("virtualArray", type = "source")
#library(devtools)
#install_url("http://www.bioconductor.org/packages/2.14/bioc/src/contrib/virtualArray_1.8.0.tar.gz")
#install.packages("http://www.bioconductor.org/packages//2.11/bioc/src/contrib/virtualArray_1.2.1.tar.gz", repos = NULL, type="source")
